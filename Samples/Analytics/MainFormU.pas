...
begin
  GlobalEventBus.Post(BuildAnalyticsEvent('Button1 Clicked'), '', TEventMM.Automatic);
  ShowMessage('You clicked ' + Button1.Name);
end;

procedure TForm6.FormResize(Sender: TObject);
begin
  GlobalEventBus.Post(BuildAnalyticsEvent('Analytics form changed size'), '', TEventMM.Automatic);
end;
...
begin
  GlobalEventBus.Post(BuildAnalyticsEvent('Memo1 Changed'), '', TEventMM.Automatic);
end;
...
begin
  ...
  GlobalEventBus.Post(BuildAnalyticsEvent(LChoice +
    ' is actual favorite food '), '', TEventMM.Automatic);
end;
